      ...
      advice =  <h3>Loading</h3>
        ...
        if (this.props.purchasePrice === '') {
          ...
          if (data[0].credit < 620 && data[0].assets < (data[0].downpayment + 10000)) {
            message = <h3>Your credit score is too low and you do not have enough chas to buy this property. </h3>
          ...
          else if (((data[0].debts + data[0].housingPayment ) / data[0].income) > .45) {
